...
class DocumentProcessor:
            ...
            def _replace_mergefields_in_paragraph(para, record_map) -> int:
                ...
                for fld_simple in para._p.findall('.//'+qn('w:fldSimple')):
                    ...
                    if value is not None:
                        # Replace all text nodes inside this field with value
                ...
                while i_run < len(runs):
                    ...
                    if found_name:
                        ...
                        if value is None:
                            i_run += 1
                            continue
                        # Replace subsequent runs until fldChar type end
                        j = i_run + 1
                        while j < len(runs):
                            end_field = False
    ...
    def add_image_watermark(self, image_path: str, width_inches: float = 4.0,
        ...
        try:
            ...
            # Note: True opacity requires DrawingML manipulation
            # This adds a centered header image as a simple watermark
            return f"Image watermark added (header-based, {width_inches} inches wide)"
        except Exception as e:
